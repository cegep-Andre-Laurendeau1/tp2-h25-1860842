...
public class Main {
    public static void main(String[] args) throws SQLException, InterruptedException, DatabaseException {
        ...
        try {
            ...
            ps.saveCd("Thriller", "Michael Jackson", 42, "Pop", 3);
...
//            es.emprunteDocument(2, 1);
            ...
            System.out.println(ps.getNbDocumentEmprunte(1));
        } catch (DatabaseException e){
            throw new DatabaseException("Erreur lors de l'ajout des insertions", e);
        }
